...
import { cockpitModelCatalogRows } from "./cockpit-provider";
...
export function augmentNativeModelCatalog(
  ...
  const cockpitModels = includeCockpitModels ? cockpitModelCatalogRows(config) : [];
  return {
    ...structuredClone(catalog),
    models: [...nativeModels, ...webModels, ...cockpitModels],
  };
}
