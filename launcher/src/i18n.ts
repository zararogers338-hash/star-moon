...
const en = {
  ...
  biggerContext: "Endless Night",
  biggerContextTagline: "The moon seems as though it will never set.",
  biggerContextSubtitle: "Experimental · Enable 3× Chat context",
  biggerContextBody: "Warning: this expands context handling, not your account usage allowance. It keeps small turns as one message, then splits large context across two or three messages. The final part starts the task without an extra request. It triples the model context and compaction thresholds; restart Codex after changing it. Extra requests may increase rate limits or temporary cooldowns. Disabled by default.",
  biggerContextRecommendationTitle: "Endless Night",
  biggerContextRecommendationBody: "Endless Night sends large tasks in multiple messages to handle up to three times more ChatGPT Web context, not to increase your account usage allowance. It remains experimental and can increase rate limits or temporary cooldowns.",
  ...
  languageSaveFailed: "The language could not be saved. Please try again.",
  english: "English",
  chinese: "简体中文",
  ...
  german: "Deutsch",
  continue: "Continue",
  supportTitle: "If you can, please give me a star.",
  supportBody: "Entirely optional. Either choice opens the app. GitHub opens only if you choose it; nothing is starred automatically.",
  star: "Sure, let's give a star",
  supportLater: "Maybe next time",
  ...
  setupTitle: "Set up Project Star & Moon",
  ...
  automaticInteraction: "Radiant Moon",
  automaticInteractionSubtitle: "Automation mode",
  ...
  manualInteraction: "Newborn Crescent",
  manualInteractionSubtitle: "Manual collaboration mode",
  ...
  signIn: "Open sign in",
  passkeySignIn: "Sign in with an external browser",
  passkeyContinue: "Continue",
  passkeyImporting: "Importing…",
  passkeyContinueBody: "Finish sign-in in the dedicated browser window, close that window, then return here to authorize transfer of its ChatGPT/OpenAI session only.",
  checkingSignIn: "Checking saved session",
  verifySignIn: "Check sign in",
  signedIn: "Signed in",
  stepSmoke: "Run browser smoke test",
  stepSmokeBody: "Select High, send a small ordinary message, and verify a complete streamed response.",
  ...
  native2Title: "Native2 · advanced tool return",
  native2Subtitle: "Returns tools to the current ChatGPT Web turn. This advanced connection is separate from AgentDock.",
  native2PreviewNotice: "Preview only · Browse all three pages without keys, installation, authorization or connection checks. No account allowance is used.",
  native2PreviewNext: "Next preview", native2PreviewExit: "Back to AgentDock preview", native2PreviewField: "Preview only — leave empty",
  native2PreviewStepOne: "See where the tunnel setup begins. Website buttons are disabled in this preview.",
  native2PreviewStepTwo: "These fields are for display only. Continue without entering credentials; nothing is saved or installed.",
  native2PreviewStepThree: "This is the last preview page. No connector was added and no runtime was verified. Return to AgentDock when you are finished.",
  ...
  keepRunningOnClose: "Night Watch",
  keepRunningOnCloseSubtitle: "Keep running after closing the window",
...
const zh: Record<keyof typeof en, string> = {
  ...
  biggerContext: "永夜",
  biggerContextTagline: "月亮似乎永远也不会落下",
  biggerContextSubtitle: "实验性 · 开启 3× Chat 上下文",
  biggerContextBody: "警告：扩大的是上下文处理范围，不增加账号用量额度。较小回合仍作为一条消息发送；较大的上下文会拆分为两条或三条消息，最后一部分会直接开始任务，不会额外发送请求。模型上下文和压缩阈值将扩大三倍；更改后请重启 Codex。额外请求可能提高触发速率限制或临时冷却的概率。默认关闭。",
  biggerContextRecommendationTitle: "永夜",
  biggerContextRecommendationBody: "永夜通过多条消息发送大型任务，处理多达三倍的 ChatGPT Web 上下文，不增加账号用量额度。此功能仍处于实验阶段，可能增加触发速率限制或临时冷却的概率。",
  ...
  russian: "Русский",
  german: "Deutsch",
  supportTitle: "如果可以的话，请给我一颗星星吧。",
  supportBody: "完全自愿，两个选择都可以直接进入。只有你选择时才会打开仓库页面，不会自动替你点赞。",
  star: "好的，这就给一颗",
  supportLater: "下次再说",
  finishWelcome: "打开启动器",
  setup: "设置",
  ...
  signIn: "打开登录",
  passkeySignIn: "在外部浏览器中登录",
  passkeyContinue: "继续",
  passkeyImporting: "正在导入…",
  passkeyContinueBody: "请在专用浏览器窗口中完成登录并关闭该窗口，然后回到这里点击继续，仅授权交接此次 ChatGPT/OpenAI 会话。",
  checkingSignIn: "正在检查已保存的会话",
  verifySignIn: "检查登录",
  signedIn: "已登录",
  stepSmoke: "运行浏览器冒烟测试",
  stepSmokeBody: "选择 High，发送一条普通消息，并验证完整的流式响应。",
  runSmoke: "运行冒烟测试",
  smokePassed: "冒烟测试通过",
  ...
  native2Title: "Native2 · 高级工具回传",
  native2Subtitle: "把工具结果送回当前 ChatGPT 网页对话的高级连接，与 AgentDock 配置相互独立。",
  native2PreviewNotice: "仅预览 · 三个页面都可以查看，无需密钥，不会安装、授权或检查真实连接，也不消耗账号额度。",
  native2PreviewNext: "继续预览", native2PreviewExit: "返回 AgentDock 预览", native2PreviewField: "仅预览，无需填写",
  native2PreviewStepOne: "查看隧道配置从哪里开始。预览中的网站按钮不会打开真实页面。",
  native2PreviewStepTwo: "这里只展示输入框的样子。无需填写凭据即可继续，不会保存或安装任何内容。",
  native2PreviewStepThree: "这是预览的最后一页，尚未添加连接器或验证运行环境。查看完后，可以返回 AgentDock。",
  ...
  keepRunningOnCloseSubtitle: "关闭窗口后继续在后台运行",
...
const ja: Record<keyof typeof en, string> = {
  ...
  biggerContext: "永夜",
  biggerContextTagline: "月は、いつまでも沈まないように。",
  biggerContextSubtitle: "試験的 · 3× Chat コンテキストを有効にする",
  biggerContextBody: "警告：拡張されるのはコンテキストの処理範囲であり、アカウントの利用枠は増えません。小さなターンは 1 件のメッセージとして維持し、大きなコンテキストは 2～3 件のメッセージに分割します。最後の部分から追加リクエストなしでタスクを開始します。モデルのコンテキスト上限とコンパクションしきい値が 3 倍になります。変更後は Codex を再起動してください。追加リクエストにより、レート制限や一時的なクールダウンが発生しやすくなる場合があります。初期設定では無効です。",
  biggerContextRecommendationTitle: "永夜",
  biggerContextRecommendationBody: "永夜は大きなタスクを複数のメッセージで送信し、最大 3 倍の ChatGPT Web コンテキストを処理します。アカウントの利用枠は増えません。試験的な機能であり、レート制限や一時的なクールダウンが発生しやすくなる場合があります。",
  ...
  russian: "Русский",
  german: "Deutsch",
  supportTitle: "よろしければ、スターを一つお願いします。",
  supportBody: "完全に任意です。どちらを選んでもアプリを使えます。選んだ場合だけ GitHub を開き、自動でスターは付けません。",
  star: "はい、スターを付けに行く",
  supportLater: "また今度",
  ...
  automaticInteraction: "清らかな明月",
  automaticInteractionSubtitle: "自動化モード",
  ...
  manualInteraction: "生まれたての幼月",
  manualInteractionSubtitle: "手動協働モード",
  ...
  signIn: "サインインを開く",
  passkeySignIn: "外部ブラウザーでサインイン",
  passkeyContinue: "続行",
  passkeyImporting: "インポート中…",
  passkeyContinueBody: "専用ブラウザーでサインインし、そのウィンドウを閉じてから戻ってください。続行すると、この ChatGPT/OpenAI セッションのみの引き継ぎを許可します。",
  checkingSignIn: "保存済みセッションを確認中",
  verifySignIn: "サインインを確認",
  signedIn: "サインイン済み",
  stepSmoke: "ブラウザーのスモークテストを実行",
  stepSmokeBody: "High を選択して短い通常メッセージを送信し、完全なストリーミング応答を確認します。",
  runSmoke: "スモークテストを実行",
  ...
  native2Title: "Native2 · 高度なツール返却",
  native2Subtitle: "現在の ChatGPT Web ターンにツール結果を返す高度な接続です。AgentDock とは別の設定です。",
  native2PreviewNotice: "プレビューのみ · キーを入力せずに全 3 ページを確認できます。インストール、認証、実際の接続確認、利用枠の消費はありません。",
  native2PreviewNext: "次をプレビュー", native2PreviewExit: "AgentDock のプレビューに戻る", native2PreviewField: "プレビューのみ — 入力不要",
  native2PreviewStepOne: "トンネル設定の開始画面を確認できます。プレビューでは Web サイトのボタンは無効です。",
  native2PreviewStepTwo: "入力欄は表示のみです。認証情報を入力せずに次へ進めます。保存やインストールは行いません。",
  native2PreviewStepThree: "プレビューの最後のページです。コネクタの追加や実行環境の確認は行っていません。確認が終わったら AgentDock に戻れます。",
  ...
  keepRunningOnClose: "夜の見守り",
  keepRunningOnCloseSubtitle: "ウィンドウを閉じてもバックグラウンドで実行",
...
export function copyFor(language: Language): Copy {
  if (language === "zh-Hant") return zhHant as Copy;
